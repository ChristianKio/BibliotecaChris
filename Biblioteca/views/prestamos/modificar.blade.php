    ...
    <h1>Modificar prestamos</h1>
        ...
        <form action="" method="post" >
            ...
            <p>
                ...
                <input class="form-control" id="fecha_prestamo" type="date" value="{{$prestamos["fecha_prestamo"]}}" name="fecha_prestamo">
            </p>

            <p>
                <label for="fecha_devolucion">Fecha de devolucion</label>
                <input class="form-control" id="fecha_devolucion" type="date" value="{{$prestamos["fecha_devolucion"]}}"  name="fecha_devolucion">
            </p>
