...
<div class="container">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenu">
                                <li><a class="dropdown-item"
                                       href="dashboard.php?id={{$_SESSION["usuario"]["id"]}}">Perfil</a></li>
                            @if ($_SESSION["usuario"]["tipo"] === "bibliotecario")
                                <li><a class="dropdown-item" href="index.php?id={{$_SESSION["usuario"]["id"]}}">Administracion</a>
                                </li>
                            @endif
    ...
    <div class="row">
        <h1 class="text-center border-bottom pb-4 mb-4">DashBoard</h1>
    </div>
